...
INSERT INTO `tbl_login` (`id_login`, `NIP`, `user`, `pass`, `level`, `nama`, `tempat_lahir`, `tgl_lahir`, `jenkel`, `alamat`, `telepon`, `email`, `tgl_bergabung`, `foto`) VALUES
...
INSERT INTO `tbl_pinjam` (`id_pinjam`, `pinjam_id`, `NIP`, `buku_id`, `status`, `tgl_pinjam`, `lama_pinjam`, `tgl_balik`, `tgl_kembali`) VALUES
