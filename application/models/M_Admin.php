  ...
  public function detailpinjam()
{
    ...
    // Ambil data nomor seri dari tbl_pinjam
    $serial_numbers = $this->M_Admin->get_serial_numbers($id);

    // Melewatkan data nomor seri ke tampilan
    $this->data['serial_num'] = $serial_num;

    // ... Bagian kode selanjutnya ...
}

public function get_serial_numbers($pinjam_id)
{
    // Ambil data nomor seri berdasarkan pinjam_id dari tbl_pinjam
    $query = $this->db->get_where('tbl_pinjam', array('pinjam_id' => $pinjam_id));
