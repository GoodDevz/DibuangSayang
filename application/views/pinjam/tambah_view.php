									...
									<tr>
										...
										<td>
											<div class="input-group">
												<input type="text" class="form-control" required autocomplete="off" name="NIP" id="search-box" placeholder="Contoh ID Anggota : AG001" type="text" value="">
							...
							<div class="col-sm-7">
								<table class="table table-striped">
									...
									<tr>
										...
										<td>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="checkbox" name="buku_id[]" id="kabel_data" value="kabel_data">
												<label class="form-check-label" for="kabel_data">Kabel Data</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="checkbox" name="buku_id[]" id="charger" value="charger">
												<label class="form-check-label" for="charger">Charger</label>
											</div>
											<div class="form-check form-check-inline">
												<input class="form-check-input" type="checkbox" name="buku_id[]" id="case" value="case">
									...
									<tr>
										...
										<td>:</td>
										<td>
											<input type="text" class="form-control" autocomplete="off" name="serial_number" placeholder="Masukkan MAC Address">
										</td>
									</tr>
									<tr>
										<td>Data Buku</td>
